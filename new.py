...
def already_exist(path: str) -> bool:
...
def gen_markdown(path: str, content: str, title: str, url: str) -> None:
    """ 生成 markdown 文件
    """
    if already_exist(path):
        print("already exist file: ", path)
        return
